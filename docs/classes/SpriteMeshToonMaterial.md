...
- *typeof* `MeshToonMaterial` & [`SpriteMaterial`](SpriteMaterial.md)\<`this`\>

## Constructors

### new SpriteMeshToonMaterial()

> **new SpriteMeshToonMaterial**(`args`): [`SpriteMeshToonMaterial`](SpriteMeshToonMaterial.md)
